...
class FileUploadUtils {
    static uploadImg(imgPath, imgName, imgSuffix) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!imgSuffix) {
                imgSuffix = 'png';
            }
            const minioResp = yield minioClient.fPutObject(bucketName, `${imgName}.${imgSuffix}`, imgPath);
...
exports.default = FileUploadUtils;
